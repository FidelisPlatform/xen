    ...
    struct boot_info *info)
{
    ...
    bootmod_type_t type = BOOTMOD_UNKNOWN;
    int len;
        ...
        case BOOTMOD_KERNEL:
            ...
            if ( !bm->string.len )
            {
                ...
                if ( prop )
                {
                    ...
                    size = size > BOOTMOD_STRING_MAX_LEN ?
                           BOOTMOD_STRING_MAX_LEN : size;
